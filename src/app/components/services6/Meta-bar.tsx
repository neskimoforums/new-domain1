    ...
    <div className="relative z-50 border-b border-[#00e5ff1a] bg-[#00e5ff0d] py-[10px]">
      <div className="container-shell">
        <div 
          ...
          className="flex flex-wrap items-center gap-[20px] text-[12px] tracking-wider text-[#94a3b8]"
        >
          {/* Published Item */}
          ...
          <div className="flex items-center gap-[6px]">
            ...
            <strong className="font-bold text-sm text-[#a3ff57] drop-shadow-[0_0_8px_rgba(190,242,100,0.3)]">
              March 10, 2026
            </strong>
          </div>
